...
<br/>
<br/>
    To aid the controller in working with the different search providers, I've envisioned that a separate class will exist
for every search provider supported, following the Single Responsibility Principle. For the purposes of this assignment, 
I've added a new App\Services layer and inside of it created two service classes: AbstractSearchProviderService and GitHubService.
<br/>
<br/>
